...
const ReactHookForm: React.FC = () => {
  ...
  return (
    <>
      <form
        className="bg-blue-50 rounded-[8px] p-[20px]"
        onSubmit={handleSubmit(onSubmit)}
      >
        {/* input text */}
        <div className="mb-[20px]">
          <div className="mb-[4px]">
            <label htmlFor="input" className="u-h4">
              input
            </label>
          </div>
          <div>
            <div className="u-text flex flex-(items-center justify-between) gap-[8px] border-(solid 1 gray) rounded-[4px] py-[8px] px-[10px]">
              ...
              <button
                type="button"
                className={`i-material-symbols:close-small-outline-rounded flex-shrink-0 u-transition-ease ${values['input'] && values['input'] !== '' ? 'opacity-100' : 'opacity-0'}`}
                onClick={() => handleInputClear('input')}
              ></button>
            </div>
            {errors['input'] && (
              <p className="u-caption text-error mt-[4px]">
                {(errors['input'] as FieldError).message}
              </p>
            )}
        ...
        <div className="mb-[20px]">
          <div className="mb-[4px]">
            <label htmlFor="email" className="u-h4">
              email
            </label>
          </div>
          <div>
            <div className="u-text flex flex-(items-center justify-between) gap-[8px] border-(solid 1 gray) rounded-[4px] py-[8px] px-[10px]">
              ...
              <button
                type="button"
                className={`i-material-symbols:close-small-outline-rounded flex-shrink-0 u-transition-ease ${values['email'] && values['email'] !== '' ? 'opacity-100' : 'opacity-0'}`}
                onClick={() => handleInputClear('email')}
              ></button>
            </div>
            {errors['email'] && (
              <p className="u-caption text-error mt-[4px]">
        ...
        <div className="mb-[20px]">
          <div className="mb-[4px]">
            <label htmlFor="select" className="u-h4">
              select
            </label>
          </div>
          <div>
            ...
            {errors['select'] && (
              <p className="u-caption text-error mt-[4px]">
                {(errors['select'] as FieldError).message}
              </p>
            )}
            <div className="u-caption text-gray mt-[4px]">備註文字</div>
          </div>
        ...
        <div className="mb-[20px]">
          <div className="mb-[4px]">
            <label htmlFor="select_1" className="u-h4">
              select
            </label>
          </div>
          <div>
            ...
            {errors['select_1'] && (
              <p className="u-caption text-error mt-[4px]">
                {(errors['select_1'] as FieldError).message}
              </p>
            )}
            <div className="u-caption text-gray mt-[4px]">備註文字</div>
          </div>
        ...
        <div className="mb-[20px]">
          ...
          <div>
                ...
                <input
                  ...
                  {...register('check', {
                    onChange: (e) => {
                      ...
                      if (e.target.checked) {
                        setValue('check', [...currentValue, e.target.value], {
                          shouldValidate: true,
                        });
                      } else {
                        setValue(
            ...
            {errors['check'] && (
              <p className="u-caption text-error mt-[4px]">
                {(errors['check'] as FieldError).message}
              </p>
            )}
            <div className="u-caption text-gray mt-[4px]">備註文字</div>
          </div>
        ...
        <div className="mb-[20px]">
          ...
          <div>
            ...
            {errors['radio'] && (
              <p className="u-caption text-error mt-[4px]">
                {(errors['radio'] as FieldError).message}
              </p>
            )}
            <div className="u-caption text-gray mt-[4px]">備註文字</div>
          </div>
        ...
        <div className="mb-[20px]">
          <div className="mb-[4px]">
            <label htmlFor="textarea" className="u-h4">
              textarea
            </label>
          </div>
          <div>
            <div className="u-text flex flex-(items-center justify-between) gap-[8px] border-(solid 1 gray) rounded-[4px] py-[8px] px-[10px]">
              <textarea
                ...
                {...register('textarea')}
                onChange={(e) =>
                  setValue('textarea', e.target.value, { shouldValidate: true })
                }
              ></textarea>
            </div>
            {errors['textarea'] && (
              <p className="u-caption text-error mt-[4px]">
                {(errors['textarea'] as FieldError).message}
              </p>
            )}
            <div className="u-caption text-gray mt-[4px]">備註文字</div>
          </div>
