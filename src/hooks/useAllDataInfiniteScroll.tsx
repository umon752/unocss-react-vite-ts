...
export const useAllDataInfiniteScroll = (
  options: AllDataInfiniteScrollOptions
) => {
  // 預設值
  ...
  const lockTarget: HTMLElement | null =
    options.scrollTarget ?? document.querySelector('body');
